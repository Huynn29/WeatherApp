...
import com.weatherapp.di.DatabaseModule_ProvideDatabaseFactory;
import com.weatherapp.di.DatabaseModule_ProvideWeatherDaoFactory;
import com.weatherapp.di.NetworkModule_ProvideOkHttpClientFactory;
import com.weatherapp.di.NetworkModule_ProvideRetrofitFactory;
import com.weatherapp.di.NetworkModule_ProvideWeatherApiServiceFactory;
import com.weatherapp.ui.home.HomeFragment;
import com.weatherapp.ui.home.HomeViewModel;
import com.weatherapp.ui.home.HomeViewModel_HiltModules;
...
public final class DaggerWeatherApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends WeatherApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_weatherapp_ui_home_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_weatherapp_ui_home_HomeViewModel = "com.weatherapp.ui.home.HomeViewModel";

      @KeepFieldType
      HomeViewModel com_weatherapp_ui_home_HomeViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends WeatherApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_weatherapp_ui_home_HomeViewModel, ((Provider) homeViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.weatherapp.ui.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.weatherRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends WeatherApplication_HiltComponents.SingletonC {
    ...
    private WeatherDao weatherDao() {
      return DatabaseModule_ProvideWeatherDaoFactory.provideWeatherDao(provideDatabaseProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.weatherapp.data.repository.WeatherRepository 
          return (T) new WeatherRepository(singletonCImpl.provideWeatherApiServiceProvider.get(), singletonCImpl.weatherDao());

          case 1: // com.weatherapp.data.api.WeatherApiService 
          ...
          case 4: // com.weatherapp.data.local.AppDatabase 
