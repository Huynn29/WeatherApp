...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull SwipeRefreshLayout rootView, @NonNull Button btnLocation,
      @NonNull FloatingActionButton fabSearch, @NonNull ImageView ivWeatherIcon,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvForecast,
      @NonNull SwipeRefreshLayout swipeRefresh, @NonNull TextView tvCityName,
      @NonNull TextView tvDescription, @NonNull TextView tvFeelsLike, @NonNull TextView tvHumidity,
      @NonNull TextView tvPressure, @NonNull TextView tvSunrise, @NonNull TextView tvSunset,
      @NonNull TextView tvTemperature, @NonNull TextView tvUpdated, @NonNull TextView tvVisibility,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((SwipeRefreshLayout) rootView, btnLocation, fabSearch,
          ivWeatherIcon, progressBar, rvForecast, swipeRefresh, tvCityName, tvDescription,
          tvFeelsLike, tvHumidity, tvPressure, tvSunrise, tvSunset, tvTemperature, tvUpdated,
          tvVisibility, tvWind);
    }
